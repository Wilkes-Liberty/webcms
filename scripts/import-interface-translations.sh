...
if [ ! -f "translations/interface/es-interface.po" ]; then
    ...
    ddev drush locale:import es translations/interface/es-interface.po --type=customized --override=all
fi
...
if [ ! -f "translations/interface/ru-interface.po" ]; then
    ...
    ddev drush locale:import ru translations/interface/ru-interface.po --type=customized --override=all
fi
