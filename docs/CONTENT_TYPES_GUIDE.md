...
**For detailed field specifications, usage guidelines, and examples, see [FIELD_REFERENCE.md](FIELD_REFERENCE.md)**

The FIELD_REFERENCE.md guide provides comprehensive documentation for all 54+ fields available across content types, including:

- **Critical Fields**: Persona targeting, SEO optimization, media management, and call-to-action fields
- **Content Organization**: Classification, publishing, and relationship fields  
- **Technical Fields**: System configuration, caching, and workflow fields
- **Business Fields**: Capability, compliance, and campaign tracking fields

## Quick Field Reference for Content Creators

Below are the most commonly used fields for each content type. For complete specifications and usage examples, reference the [FIELD_REFERENCE.md](FIELD_REFERENCE.md) guide.
...
1. **Start with Core Fields**: Focus on body content, personas, and primary CTA first
2. **SEO Optimization**: Always complete meta_description and seo_title for public content
3. **Visual Content**: Use hero_image consistently, set focal points for responsive design
4. **Audience Targeting**: Select appropriate personas to enable content personalization
5. **Conversion Focus**: Every piece of content should have a clear primary CTA

**👉 For complete field documentation with examples and best practices, see [FIELD_REFERENCE.md](FIELD_REFERENCE.md)**
